// Fire Effect Shader for Phaser 3
// Based on high-quality fire shader sample
window.FireShader = class FireShader extends Phaser.Renderer.WebGL.Pipelines.SinglePipeline {
    constructor(game) {
        super({
            game: game,
            ...
            fragShader: `
                ...
                // Fire shader implementation based on sample
                float rand(vec2 n) {
    ...
    onPreRender() {
        ...
        this.set1f('fireScale', this.fireScale || 1.0);
    }
