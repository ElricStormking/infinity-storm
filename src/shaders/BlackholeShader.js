    ...
    constructor(game) {
        super({
            ...
            fragShader: `
                ...
                // Dark purple emission
                    vec3 emissionColor = emission(vec3(0.40, 0.00, 0.60), noiseColorLength * 0.22);
                    ...
                    // Apply an overall dark purple tint to the final color
                    color *= vec3(0.40, 0.10, 0.60);
