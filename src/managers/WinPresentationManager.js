...
window.WinPresentationManager = class WinPresentationManager {
    ...
    showBigFreeSpinsMessage(freeSpins) {
        // No-op: we now start Free Spins immediately without banner.
        console.log(`[WinPresentationManager] FreeSpins banner disabled; spins start immediately (${freeSpins})`);
    }
